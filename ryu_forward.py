            ...
            if eth.ethertype == ether_types.ETH_TYPE_IP:
                ...
                #  if TCP Protocol
                    ...
                    if t.bits & tcp.TCP_SYN:
                        self.logger.info("TCP SYN detected: %s -> %s", srcip, dstip)
                        match = parser.OFPMatch(
                        ...
                        #when detect a SYN packet, we send out a packet_out in if and return in case that send the same packet twice.
                    ...
                    #for other pack, we use the unified packet_out at the end of the function.
                        match = parser.OFPMatch(
                        eth_type=ether_types.ETH_TYPE_IP,
                        in_port=in_port,
                        ipv4_src=srcip,
